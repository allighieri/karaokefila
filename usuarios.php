    ...
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-danger"><i class="bi bi-info-circle-fill"></i> Clique no nível para alterar.</p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="visualizar-nome"></h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <p><strong>E-mail:</strong> <span id="visualizar-email"></span></p>
