...
<div class="container mt-5">
    ...
    <?php if ($cantor_selecionado_id && !empty($cantores_disponiveis)): ?>
        ...
        <form method="POST">
            ...
            <label for="search_musica">Pesquisar Música por título, artista, código ou trecho...:</label>

            <div class="row"> <div class="col-12 col-lg-12"> <div class="input-group mb-3">

                        <input type="text" class="form-control" id="search_musica" placeholder="Digite para buscar músicas..." autocomplete="off" required>

                        <button class="btn btn-primary" type="submit" id="button-addon2">Adicionar Música ao Cantor</button>
